    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if projects:
                ...
                htmx_response = requests.get(f"{BASE_URL}/projects/{project_id}", headers=htmx_headers)
                ...
                if error_response.status_code == 404:
                    ...
                    print(f"   ⚠️  Unexpected status code for invalid ID: {error_response.status_code}")
                
                # Test HTMX error handling
                htmx_error_response = requests.get(f"{BASE_URL}/projects/invalid-id", headers=htmx_headers)
