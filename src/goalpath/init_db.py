...
class DatabaseInitializer:
    ...
    def create_goal_project_links(session: Session, goals: List[Goal], projects: List[Project]):
        ...
        links = [
            ...
            GoalProject(goal_id=customer_satisfaction.id, project_id=website_project.id, weight=0.4),
    ...
    def get_database_stats(session: Session) -> Dict[str, Any]:
        ...
        # Goal statistics
        goal_status_counts = session.query(
        ...
        goal_type_counts = session.query(
            Goal.goal_type, func.count(Goal.id)
