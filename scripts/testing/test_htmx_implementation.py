...
def test_htmx_project_creation():
    ...
    # HTMX headers
    htmx_headers = {"HX-Request": "true", "Content-Type": "application/x-www-form-urlencoded"}
    ...
    response = requests.post(
        f"{BASE_URL}/htmx/projects/create", data=project_data, headers=htmx_headers
    )
...
def test_htmx_without_headers():
    ...
    regular_headers = {"Content-Type": "application/x-www-form-urlencoded"}

    response = requests.post(
        f"{BASE_URL}/htmx/projects/create", data=project_data, headers=regular_headers
    )
