...
def verify_schema(db_path: str = "goalpath.db"):
    ...
    """
    expected_tables = [
        'projects', 'tasks', 'task_dependencies', 'goals', 'goal_projects',
        'sprints', 'sprint_tasks', 'reminders', 'schedule_events',
        'project_context', 'task_comments', 'task_attachments', 'issues'
    ]
